...
class TestWindowsPathShapes:
    ...
    def test_foreign_drive_and_unc_are_not_probed(self) -> None:
    ...
    def test_unc_home_share_is_path_like(self) -> None:
        from unittest.mock import patch
    ...
    def test_drive_shapes_are_inert_on_posix_homes(self) -> None:
        # On a POSIX host home has no drive, so drive/UNC tokens are not
        # path-like at all -- no behavior change for POSIX workflows.
        from unittest.mock import patch
