...
function ConfirmSharing({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="mcp-sharing-confirm-title"
    >
      <div className="w-full max-w-[520px] overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--card)] shadow-xl">
        <h3
          id="mcp-sharing-confirm-title"
          className="px-5 pt-5 text-[17px] font-semibold text-[var(--text)]"
        >
          {i18nT('pages.mcpManagement.confirm_title')}
        </h3>
        <div className="px-5 pb-1 pt-3 text-[13.5px] leading-relaxed text-[var(--muted)]">
        ...
        <div className="mt-3 flex items-center justify-between gap-3 border-t border-[var(--border)] px-5 py-4">
          <a
            href={DOCS_URL}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <div className="flex gap-2.5">
            <button
              type="button"
              onClick={onCancel}
              className="rounded-md border border-[var(--border)] px-3.5 py-2 text-[13.5px] text-[var(--text)]"
            >
